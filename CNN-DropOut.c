...
long double apply_conv(Image_t image, int** labels,  int classes,int f,int conv_s, Filter_t filt1 ,Matrix_t bias1, int pool_f,int pool_s,Filter_t filt2,Matrix_t bias2,Matrix_t w3,Matrix_t w4,long double*** grad_w,long double**** grad_f,long double**** grad_b,Matrix_t b3,Matrix_t b4,Filter_t dfilt1,Filter_t dfilt2,Matrix_t dbias1,Matrix_t dbias2,Matrix_t dbias3,Matrix_t dbias4, Matrix_t dw3, Matrix_t dw4, int* predicted,Filter_t filt5,Matrix_t bias5,Filter_t dfilt5,Matrix_t dbias5,Filter_t filt7,Matrix_t bias7,Filter_t dfilt7,Matrix_t dbias7){
    ...
    remove("randomNumberForDropOut.txt");
    char command[50];
    strcpy( command, "python3 randomDropOut.py 3211264 0.5" );
    system(command);
    Matrix_t D;
    matrix_initialize_n(&D,filt2.depth_out*width*height,1);
    fill_matrix(D,"randomNumberForDropOut.txt");
    ...
    print_matrix("aabb",fc);
    matrices_mul_n(fc,D);
    print_matrix("aabbcc",fc);
    matrix_div_scalar(fc,0.5);
    print_matrix("aabbccdd",fc);
...
int main( int argc, char** argv ) {
  ...
  if(test==0){  
    ...
    */
    ...
    char w3_file[33];
    char w4_file[33];
    snprintf(f1_file, 33, "weights_1922DO/f1_trained_aug_v%d", file_update);
    snprintf(f2_file, 33, "weights_1922DO/f2_trained_aug_v%d", file_update);
    snprintf(f5_file, 33, "weights_1922DO/f5_trained_aug_v%d", file_update);
    snprintf(f7_file, 33, "weights_1922DO/f7_trained_aug_v%d", file_update);
    snprintf(b1_file, 33, "weights_1922DO/b1_trained_aug_v%d", file_update);
    snprintf(b2_file, 33, "weights_1922DO/b2_trained_aug_v%d", file_update);
    snprintf(b3_file, 33, "weights_1922DO/b3_trained_aug_v%d", file_update);
    snprintf(b4_file, 33, "weights_1922DO/b4_trained_aug_v%d", file_update);
    snprintf(b5_file, 33, "weights_1922DO/b5_trained_aug_v%d", file_update);
    snprintf(b7_file, 33, "weights_1922DO/b7_trained_aug_v%d", file_update);
    snprintf(w3_file, 33, "weights_1922DO/w3_trained_aug_v%d", file_update);
    snprintf(w4_file, 33, "weights_1922DO/w4_trained_aug_v%d", file_update);
 ...
 for(int t=0;t<50;t++){ 
      ...
      uint16_t tot_img_test_cat = 10;
      Image_t* images_test_cat = (Image_t*)malloc(tot_img_test_cat*sizeof(Image_t));
      
      uint16_t tot_img_test_dog = 10;
      Image_t* images_test_dog = (Image_t*)malloc(tot_img_test_dog*sizeof(Image_t));
      //"test/cats_bmp/%d.bmp"
      //"test/dogs_bmp/%d.bmp"
      load_images_from_memory( images_test_dog,tot_img_test_dog,"cats_dogs/dogs/%d.bmp",image_dim,image_dim,image_channels);
      load_images_from_memory( images_test_cat,tot_img_test_cat,"cats_dogs/cats/%d.bmp",image_dim,image_dim,image_channels);
     /*
      INICIO PARAMETROS
      */
          /*
    ...
    */
    ...
    char f1_file[33];
    snprintf(f1_file, 33, "weights_1922DO/f1_trained_aug_v%d", t);
    Filter_t f1;
    initializeFilter(&f1,32,image_channels,f);
    fill_filter(f1, f1_file);

    char b1_file[33];
    snprintf(b1_file, 33, "weights_1922DO/b1_trained_aug_v%d", t);
    Matrix_t b1;
    matrix_initialize_n(&b1,32,1);
    ...
    char f2_file[33];
    snprintf(f2_file, 33, "weights_1922DO/f2_trained_aug_v%d", t);
    Filter_t f2;
    initializeFilter(&f2,128,128,f);
    fill_filter(f2, f2_file);
    
    char b2_file[33];
    snprintf(b2_file, 33, "weights_1922DO/b2_trained_aug_v%d", t);
    Matrix_t b2;
    matrix_initialize_n(&b2,128,1);
    fill_matrix(b2,b2_file);
    
    char f5_file[33];
    snprintf(f5_file, 33, "weights_1922DO/f5_trained_aug_v%d", t);
    Filter_t f5;
    initializeFilter(&f5,64,32,f);
    fill_filter(f5, f5_file);
    
    char b5_file[33];
    snprintf(b5_file, 33, "weights_1922DO/b5_trained_aug_v%d", t);
    ...
    char f7_file[33];
    snprintf(f7_file, 33, "weights_1922DO/f7_trained_aug_v%d", t);
    ...
    char b7_file[33];
    snprintf(b7_file, 33, "weights_1922DO/b7_trained_aug_v%d", t);
    ...
    char w3_file[33];
    snprintf(w3_file, 33, "weights_1922DO/w3_trained_aug_v%d", t);
    ...
    char w4_file[33];
    snprintf(w4_file, 33, "weights_1922DO/w4_trained_aug_v%d", t);
    Matrix_t w4;
    matrix_initialize_n(&w4,2,512);
    ...
    char b3_file[33];
    snprintf(b3_file, 33, "weights_1922DO/b3_trained_aug_v%d", t);
    Matrix_t b3;
    matrix_initialize_n(&b3,512,1);
    ...
    char b4_file[33];
    snprintf(b4_file, 33, "weights_1922DO/b4_trained_aug_v%d", t);
    Matrix_t b4;
    matrix_initialize_n(&b4,2,1);
...
// gcc -o arqDO arquitecturaDropout.c -lm -O3
